    ...
    public class BankingDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalaryDisbursement>()
                .HasOne(sd => sd.Client)
                .WithMany(c => c.SalaryDisbursements)
                .HasForeignKey(sd => sd.ClientId)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<SalaryDisbursement>()
                .HasOne(sd => sd.ApprovedBy)
                .WithMany(bu => bu.ApprovedSalaryDisbursement)
            ...
            modelBuilder.Entity<SuperAdmin>().HasData(
                new SuperAdmin
                {
                    ...
                    PasswordHash = DatabaseSeeder.SuperAdminPasswordHash,
                    FullName = "System Administrator",
                    RoleId = 1,
                    IsActive = true,
                    CreatedAt = DatabaseSeeder.SeedDate
                }
            );
            ...
            modelBuilder.Entity<BankUser>().HasData(
                new BankUser
                {
                    Id = 2,
                    Username = "bankuser1",
                    Email = "bankuser1@sbi.com",
                    PasswordHash = DatabaseSeeder.BankUserPasswordHash,
                    FullName = "John Doe",
                    RoleId = 2,
                    BankId = 1,
                    IsActive = true,
            ...
            modelBuilder.Entity<Client>().HasData(
                new Client
                {
                    ...
                    PasswordHash = DatabaseSeeder.ClientPasswordHash,
                    ClientName = "TechCorp Solutions Pvt Ltd",
                    AccountNumber = "BPA12345678ABC001",
                ...
                new Client
                {
                    ...
                    AccountNumber = "BPA12345678ABC002",
                    AccountBalance = 7500000,
                    BankId = 2,
                    RoleId = 3,
                    IsActive = true,
                    Address = "456 Trade Avenue, Delhi",
                ...
                new Client
                {
                    ...
                    PasswordHash = DatabaseSeeder.ClientPasswordHash,
                    ClientName = "Manufacturing Industries Inc",
                    AccountNumber = "BPA12345678ABC003",
                ...
                new Client
                {
                    ...
                    PasswordHash = DatabaseSeeder.ClientPasswordHash,
                    ClientName = "FinServe Pvt Ltd",
                    AccountNumber = "BPA12345678ABC004",
                    AccountBalance = 6000000,
                    BankId = 4,
                    RoleId = 3,
                    IsActive = true,
                    Address = "321 Finance Road, Chennai",
                    PanNumber = "RSTUV3456W",
                    GstNumber = "33RSTUV3456W1Z2",
                    CreatedAt = DatabaseSeeder.SeedDate
                }
            );
            ...
            modelBuilder.Entity<Employee>().HasData(
                ...
                new Employee
                {
                    ...
                    Email = "ramesh@globaltraders.com",
                    Salary = 80000,
                    ClientId = 7,
                    IsActive = true
                },
